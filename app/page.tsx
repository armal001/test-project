      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <a href="/" className="text-2xl font-bold text-blue-600">Trainto</a>
            <div className="hidden md:flex space-x-8">
              <a href="#solutions" className="text-gray-600 hover:text-blue-600">Lösungen</a>
              <a href="#benefits" className="text-gray-600 hover:text-blue-600">Vorteile</a>
              <a href="#case-studies" className="text-gray-600 hover:text-blue-600">Fallstudien</a>
            ...
            <div className="flex items-center space-x-4">
              <a href="https://traintogo.de" className="text-gray-600 hover:text-blue-600">Für Nutzer</a>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <a href="https://traintogo.de" className="text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-50 transition-colors border border-blue-600">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://traintogo.de" className="text-gray-400 hover:text-white">traintogo.de (Für Nutzer)</a></li>
